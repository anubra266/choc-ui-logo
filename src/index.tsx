  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="brand.600"
      />
      <path d="M548 460L443 400.5V252.5L675 385.5L548 460Z" fill="brand.600" />
      <path d="M443 1.5V147L765 335L888 260.5L443 1.5Z" fill="brand.600" />
      <path
      ...
      <path
        ...
        fill="brand.400"
      />
      <path d="M2 656.5L449 916.5V769L131 582L2 656.5Z" fill="brand.600" />
      <path
      ...
      <path
        ...
        fill="brand.400"
      />
      <path d="M0 259L3.5 407L443 146.5V0.5L0 259Z" fill="brand.400" />
    </Icon>
  );
};
